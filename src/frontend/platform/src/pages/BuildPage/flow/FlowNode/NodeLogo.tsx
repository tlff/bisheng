...
import { BookOpenTextIcon, Bot, Brain, Code2, FileDown, FilePen, FileSearch, FlagTriangleRight, Hammer, Home, Keyboard, MessagesSquareIcon, Split } from "lucide-react";
export const Icons = {
    'start': Home,
    'input': Keyboard,
